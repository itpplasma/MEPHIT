...
work_dir = '/home/patrick/git/NEO-EQ/run/geomint_30835'
...
plt.plot(data_prof[kt_low[kf]:kt_low[kf]+kt_max[kf], 0] * dyn_per_cm3_to_N_per_m3,
         '-k', lw=thin, label=r'$\nabla p_{0}$')
plt.plot(data_prof[kt_low[kf]:kt_low[kf]+kt_max[kf], 1] * dyn_per_cm3_to_N_per_m3,
         '--r', lw=thin, label='Ampere')
plt.plot(data_prof[kt_low[kf]:kt_low[kf]+kt_max[kf], 2] * dyn_per_cm3_to_N_per_m3,
         '--b', lw=thin, label='Grad-Shafranov')
plt.gca().get_yaxis().set_major_formatter(scifmt)
plt.gca().legend()
plt.xlabel(r'$\theta$')
plt.ylabel(r'$f$ / N m\textsuperscript{-3}')
plt.title('Comparison of toroidal equilibrium current (iMHD force balance)')
plt.savefig(path.join(work_dir, "check_iMHD.png"), dpi=res)
plt.close()

plt.figure(figsize=canvas)
plt.plot(data_gs[kt_low[kf]:kt_low[kf]+kt_max[kf], 0] * statA_per_cm2_to_A_per_m2,
         '-k', lw=thin, label='Grad-Shafranov')
plt.plot(data_amp[kt_low[kf]:kt_low[kf]+kt_max[kf], 0] * statA_per_cm2_to_A_per_m2,
         '--r', lw=thin, label='Ampere')
plt.gca().get_yaxis().set_major_formatter(scifmt)
plt.gca().legend()
plt.xlabel(r'$\theta$')
...
plt.figure(figsize=canvas)
plt.plot(data_gs[kt_low[kf]:kt_low[kf]+kt_max[kf], 1] * statA_per_cm2_to_A_per_m2,
         '-k', lw=thin, label='Grad-Shafranov')
plt.plot(data_amp[kt_low[kf]:kt_low[kf]+kt_max[kf], 1] * statA_per_cm2_to_A_per_m2,
         '--r', lw=thin, label='Ampere')
plt.gca().get_yaxis().set_major_formatter(scifmt)
plt.gca().legend()
plt.xlabel(r'$\theta$')
...
plt.figure(figsize=canvas)
plt.plot(data_gs[kt_low[kf]:kt_low[kf]+kt_max[kf], 2] * statA_per_cm2_to_A_per_m2,
         '-k', lw=thin, label='Grad-Shafranov')
plt.plot(data_amp[kt_low[kf]:kt_low[kf]+kt_max[kf], 2] * statA_per_cm2_to_A_per_m2,
         '--r', lw=thin, label='Ampere')
plt.gca().get_yaxis().set_major_formatter(scifmt)
plt.gca().legend()
plt.xlabel(r'$\theta$')
