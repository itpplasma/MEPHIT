...
% type = {base},
  name = {\ensuremath{\gamma}},
  sort = {G03l},
  description = {aspect ratio scaling factor to approximate cylindrical geometry in toroidal geometry}
}
...
\newglossaryentry{thetaflux}{
% type = {base},
  name = {\ensuremath{\theta}},
  sort = {G08},
  description = {poloidal angle of flux symmetry coordinates}
}
\newglossaryentry{thetageom}{
% type = {base},
  name = {\ensuremath{\vartheta}},
  sort = {G08},
  description = {poloidal angle of pseudotoroidal or \enquote{straight-cylinder} coordinates}
}
