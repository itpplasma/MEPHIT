...
The general solution for the radial component in this geometry, on which KiLCA code is based, is given by eq.~(5) from \cite{Heyn08}. For the vacuum perturbation $\Bvac$ it reduces to
\begin{gather}
