...
One aspect of resonances has not been considered yet. Starting from the static MHD equilibrium in \cref{eq:mhd-gen}, we see that only the normal component of the current density is relevant, i.e.
\begin{gather}
...
\begin{gather}
  \frac{s_{m n}}{\im (m + n q)} = \left [ \frac{J^{\parallel}}{B} \right ]_{m n}.
\end{gather}
For comparison, eq.~(1) in \cite{Waelbroeck09} gives -- after translation to the conventions of this thesis --
\begin{gather}
